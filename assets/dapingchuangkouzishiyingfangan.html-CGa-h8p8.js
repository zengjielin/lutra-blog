import{_ as i,c as t,b as s,d as a,e as l,a as c,o as d,r}from"./app-BEg0ET2i.js";const p={},v={id:"v-scale-screen",tabindex:"-1"},u={class:"header-anchor",href:"#v-scale-screen"},o={href:"https://github.com/zhangqh22/v-scale-screen",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/xiaohaijoe/ReactScaleView",target:"_blank",rel:"noopener noreferrer"},g={href:"https://github.com/china78/tgg-large-screen",target:"_blank",rel:"noopener noreferrer"};function b(h,n){const e=r("ExternalLinkIcon");return d(),t("div",null,[n[3]||(n[3]=s("h1",{id:"大屏窗口自适应方案",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#大屏窗口自适应方案"},[s("span",null,"大屏窗口自适应方案")])],-1)),s("h3",v,[s("a",u,[s("span",null,[s("a",o,[n[0]||(n[0]=a("v-scale-screen")),l(e)])])])]),n[4]||(n[4]=c(`<blockquote><p>大屏自适应容器组件，可用于大屏项目开发，实现屏幕自适应，可根据宽、高、宽高比进行自适应，实现全屏自适应。</p><p>在 2.2.0+版本中，我们同时支持 vue&gt;=v3 或者 &lt;=2.7，如果您的项目是 v2.6 版本以下，则使用 1.x 版本。</p></blockquote><ul><li><p>安装：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">npm install v-scale-screen</span>
